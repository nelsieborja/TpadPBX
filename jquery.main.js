function initVideo() {
    jQuery(".hero-area").each(function() {
        var self = jQuery(this),
            clickBtn = self.find(".btn-play"),
            containerHide = self.find(".visual"),
            videoShow = self.find(".video-block"),
            videoIframe = videoShow.find('iframe'),
        ...
        clickBtn.on("click", function(e) {
            ...
            containerHide.css("display", "none");
...
function initCarousel() {
    ...
    jQuery('.slider').scrollGallery({
        ...
        slider: '.slideset',
        slides: '.slide',
        pagerLinks: '.slick-paging .slick-slide',
        stretchSlideToMask: true
    });
    ...
    jQuery('.slideshow').scrollGallery({
        ...
        slider: '.slideset',
        slides: '.slide',
        pagerLinks: '.slick-pagination .slick-slide',
        stretchSlideToMask: true
    });
}
...
function initStickyScrollBlock() {
    jQuery('.header-sticky').stickyScrollBlock({
        setBoxHeight: true,
