...
/*
 * Edited original blade code to work as singleton...
 * This should be taken into consideration when updating this file
 */
...
class Blade {
	...
	private function __construct() {
		...
		$viewPaths = array(\Forge\Core::path('root'). '/app/views');
		$cachePath = \Forge\Core::path('root'). '/tmp/cache';
    ...
    {
        if( !isset( self::$instance_this ) )
        {
            $obj = __CLASS__;
            self::$instance_this = new $obj;
        }
         
        return self::$instance_this;
    }
	...
	{
		$obj = self::singleton();
		return $obj->instance->make($view, $data);
	}
